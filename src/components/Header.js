...
export default class Header extends Component {
    ...
    const strings  = ['UNK E-Waste Research','E-Waste Recycling Learning', 'Online/Offline Promotiom', 'Data Privacy Research', '--.- ..- .- -. - .. - .- - .. ...- .'];
      ...
      <header id="home">
        <nav id="nav-wrap">
          ...
          <ul id="nav" className="nav">
            ...
            <li><a className="smoothscroll" href="#portfolio">Statistics</a></li>
            <li><a className="smoothscroll" href="#solutions">Solutions</a></li>
            <li><a className="smoothscroll" href="#timeline">Flow</a></li>
